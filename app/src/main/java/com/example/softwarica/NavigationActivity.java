...
public class NavigationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddFragment.user_list.add(new User("Humendra Pun","Anamnagar","Male","22",R.drawable.male));
        AddFragment.user_list.add(new User("Tara Pun","Gyaneshwor","Female","21",R.drawable.female));
